...
import javax.swing.JPanel;
	...
	public class BakingImage_pie extends JFrame implements Runnable {
	    JPanel contentPane;
	    JLabel imageLabel = new JLabel();
	    JLabel headerLabel = new JLabel();

	    //파이 이미지 메서드
	    public void Image_pie() {
	        try {
	            ...
	            ImageIcon icon = new ImageIcon("C:\\Users\\adgir\\eclipse-workspace\\BakeryTycoon\\image\\applepie.gif");
