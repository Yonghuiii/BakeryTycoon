...
import javax.swing.JPanel;
	...
	public class BakingImage_cake extends JFrame implements Runnable {
	    JPanel contentPane;
	    JLabel imageLabel = new JLabel();
	    JLabel headerLabel = new JLabel();

	    //케잌 이미지 메서드
	    public void Image_cake() {
	        try {
	            ...
	            ImageIcon icon = new ImageIcon("C:\\Users\\adgir\\eclipse-workspace\\BakeryTycoon\\image\\cake.gif");
