...
import javax.swing.JPanel;
	...
	public class BakingImage_cookie extends JFrame implements Runnable {
	    JPanel contentPane;
	    JLabel imageLabel = new JLabel();
	    JLabel headerLabel = new JLabel();

	    //쿠키 이미지 메서드
	    public void Image_cookie() {
	        try {
	            ...
	            ImageIcon icon = new ImageIcon("C:\\Users\\adgir\\eclipse-workspace\\BakeryTycoon\\image\\cookie.gif");
